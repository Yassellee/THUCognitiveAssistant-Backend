...
def addIntent2file():
    ...
    csv_writer.writerow(['微信发红包', "{'微信': 0, 'personName': 0, 'money': 0}", "{}"])
    csv_writer.writerow(['微信视频通话', "{'微信': 0, 'personName': 0}", "{}"])
    csv_writer.writerow(['微信语音通话', "{'微信': 0, 'personName': 0}", "{}"])
    csv_writer.writerow(['美团打开共享单车', "{'美团': ['单车编号']}", "{}"])
    csv_writer.writerow(['报修', "{'报修': 0}", "{}"])
    csv_writer.writerow(['支付宝充话费', "{'支付宝': 0, 'personName': 0, 'money': 0}", "{}"])
    csv_writer.writerow(['支付宝查看健康码', "{'支付宝': 0}", "{}"])
    csv_writer.writerow(['支付宝转账', "{'支付宝': 0, 'personName': 0, 'money': 0}", "{}"])
    ...
    csv_writer.writerow(['微信清空聊天记录', "{'微信': 0, 'personName': 0}", "{}"])
    csv_writer.writerow(['淘宝清空购物车', "{'淘宝': 0}", "{}"])
    csv_writer.writerow(['申请出校', "{'出校': ['班级', '事由类型', '事由描述', '往来地点'], 'datetimeV2': 0, 'phoneNumber': 0}", "{'事由类型':['出校科研', '出校就医', '出校实习', '出校其他']}"])
    csv_writer.writerow(['电表充值', "{'电费': 0, 'money': 0}", "{}"])
